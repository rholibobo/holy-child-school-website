        ...
        <section className={styles.section}>
          <div className={styles.contents}>
            ...
            <p className={styles.contact_info}>
              Feel free to reach out to us using the contact form below, Your
              inquiries, feedback, and ideas are valuable to us as we continue
              to provide a nurturing and enriching educational environment for
              our students.
            </p>
          </div>
          {/* image */}
      ...
      <div className={styles.get_in_touch}>
        ...
        <div className={styles.get_us}>
          <div className={styles.get_address}>
            ...
            <p>
              {" "}
              For inquiries, or to reach us in person, visit us at Nza Street,
              Independence Layout Enugu, Nigeria
            </p>
          </div>

          <div className={styles.get_email}>
            <h3 className={styles.text_em}>
              {" "}
              <Email /> Email{" "}
            </h3>
            <p>
              {" "}
              We're here to assist you. Share your thoughts, questions, or
              feedback at
            </p>
            <Link
              href="mailto:info@holychildpreparatory.org"
          ...
          <div className={styles.get_number}>
            <h4 className={styles.text_ph}>
              {" "}
              <LocalPhone /> Phone Number{" "}
            </h4>
            <p>
              To call or chat with our team, contact us with +234 803 740 8466
              or +234 701 790 7896{" "}
            </p>
          </div>
        </div>
        ...
        <div className={styles.container}>
          ...
          <form action="" className={styles.form}>
            ...
            <main className={styles.btn}>
              <button type="button" className={styles.view_all_btn}>
                Submit
              </button>
            </main>
          </form>
